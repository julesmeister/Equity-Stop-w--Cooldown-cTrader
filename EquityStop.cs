...
namespace cAlgo.Plugins
{
    ...
    public class EquityStop : Plugin
    {
        ...
        private void InitializeLotButtons()
        {
            ...
            {
                var button = lotButtons[i];
                button.Click += (e) => HandleButtonClick(button);
            }
        }
        ...
        private void ResetEquityCompensateLoss() {
            ...
            maxProfit.Text = double.Parse(maxProfit.Text) + equityChange > 0 ? (double.Parse(maxProfit.Text) + equityChange).ToString() : "0";
